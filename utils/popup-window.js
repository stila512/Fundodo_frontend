...
/**
 * 註冊事件監聽器
 * @param {string} eventName 自定義之事件代號
 * @param {function} listener 
 */
export function addEvent(eventName, listener) {
 ...
 * @param {function} listener 
 */
export function rmEvent(eventName, listener) {
 ...
 * @param {*} data 
 */
export function pdEvent(eventName, data) {
